# Using modifications from here: https://github.com/fjij/nix-configs/blob/main/nixos-modules/satisfactory.nix
# Original source: https://github.com/matejc/helper_scripts/blob/fc6e92183135c21054314c4c65065e84daa25055/nixes/satisfactory.nix
# License: https://github.com/matejc/helper_scripts/blob/fc6e92183135c21054314c4c65065e84daa25055/LICENSE
{
  config,
  pkgs,
  lib,
...
in {
  ...
  config = lib.mkIf cfg.enable {
    users.users.satisfactory = {
      ...
      homeMode = "770"; # Added to allow another user to make backups of game data
      createHome = true;
      isSystemUser = true;
      group = "satisfactory";
    };
